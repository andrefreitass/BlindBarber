...
import br.com.blinde.barberShop.interfaceadapter.domain.request.payment.PaymentIncludeRequest;
...
@AllArgsConstructor
@NoArgsConstructor
public class ScheduleIncludeRequest implements Serializable {
    ...
    private PaymentIncludeRequest payment;
}